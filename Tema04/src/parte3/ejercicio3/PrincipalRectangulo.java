...
public class PrincipalRectangulo {
	...
	public static void main(String[] args) {
		...
		perimetro1 = rec1.getX1() + rec1.getX2() + rec1.getY1() + rec1.getY2();
		perimetro2 = rec2.getX1() + rec2.getX2() + rec2.getY1() + rec2.getY2();

		area1 = (rec1.getX1() + rec1.getX2()) * (rec1.getY1() + rec1.getY2());
		area2 = (rec2.getX1() + rec2.getX2()) * (rec2.getY1() + rec2.getY2());

		// Imrpimimos el resultado
		System.out.println("Las coordenadas del primer rectangulo son: " + rec1.getX1() + ", " + rec1.getX2() + ", "
				+ rec1.getY1() + ", " + rec1.getY2() + "Y el perímetro y el área son: " + perimetro1 + " " + area1);
		System.out.println("Las coordenadas del segundo rectangulo son: " + rec2.getX1() + ", " + rec2.getX2() + ", "
				+ rec2.getY1() + ", " + rec2.getY2() + "Y el perímetro y el área son: " + perimetro2 + " " + area2);
